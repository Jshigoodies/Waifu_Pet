...
afternoon = ["afternoon"]  # ADD THIS #ADD THIS
evening = ["evening"]  # ADD THIS #ADD THIS
...
cool = ["cold", "wind", "icy", "ice", "snow", "winter", "snowing",
        "frosty"]  # when it's windy "cool, feels nice"
wind = ["blowing", "windy"]  # when the wind is blowing
